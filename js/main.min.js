...
const buttonСountry = document.querySelectorAll(
  ".SortButton_button_country button"
);

// Добавляем обработчик клика для каждой кнопки
buttonСountry.forEach((button) => {
  button.addEventListener("click", function () {
    // Убираем класс active у всех кнопок
    buttonСountry.forEach((b) => b.classList.remove("active"));
