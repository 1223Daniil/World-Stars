...
var inputLimit = function inputLimit(input, limit) {
  input.parent().find(result).text("0 / ".concat(limit, " \u0417\u043D\u0430\u043A\u043E\u0432"));
  input.on('input', function () {
    var textLength = $(this).val().length;
    $(this).parent().find(result).text("".concat(textLength, " / ").concat(limit, " \u0417\u043D\u0430\u043A\u043E\u0432"));
    if (textLength > limit) {
...
document.addEventListener("DOMContentLoaded", function () {
  var menuTitle = document.querySelector(".header__menu-title");
